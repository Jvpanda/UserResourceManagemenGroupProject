...
class Resource
{
        public:
                ...
                // Getters
                const std::vector<std::unique_ptr<Reservation>> &getReservationList();
                std::vector<std::unique_ptr<Reservation>> &getMutableReservationList();
                int getID() const;
                ...
                void setBeginningAvailabilityHour(const int aBeginningAvailabilityHour);
                void setBeginningAvailabilityMinute(const int aBeginningAvailabilityMinute);
                ...
                void PrintResource(std::ostream &os) const;
                virtual void Print(std::ostream &os) const;
                void PrintReservationList(std::ostream &os) const;
